...
const HomePageCarousel = () => {
    ...
    <Carousel activeIndex={index} direction={direction} onSelect={handleSelect} className="carousel-main-container">
        <Carousel.Item className="carousel-item-container">
            ...
            src={`${process.env.REACT_APP_BASE_URL}/aws/carousel-image-1.png`}
            alt="First slide"
            />
        </Carousel.Item>
        ...
        <Carousel.Item className="carousel-item-container">
            <img
            className="home-page-image"
            src={`${process.env.REACT_APP_BASE_URL}/aws/carousel-image-2.png`}
            alt="Third slide"
            />
            </Carousel.Item>
        ...
        <Carousel.Item className="carousel-item-container">
            <img
            className="home-page-image"
            src={`${process.env.REACT_APP_BASE_URL}/aws/carousel-image-3.png`}
            alt="Third slide"
            />
        </Carousel.Item>
